...
export const termsConductSections: LegalSectionData[] = [
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    kanNINJA includes AI-assisted features (suggestions,
                    summaries, drafting). Outputs are generated by machine
                    learning models and:
                </p>
                <ul>
                    <li>
                        May be wrong, incomplete, or inappropriate. Review
                        before relying on them.
                    </li>
                    <li>
                        May be similar across users — outputs are not unique
                        creative works of kanNINJA's.
                    </li>
                    <li>
                        Are <strong>not legal, medical, financial, or
                        professional advice</strong>. Don't treat them as such.
                    </li>
                </ul>
                <p>
                    You may not use kanNINJA's outputs to develop a product or
                    service that competes with kanNINJA, including by training
                    or fine-tuning a machine learning model on them.
                </p>
            </>
        ),
    },
