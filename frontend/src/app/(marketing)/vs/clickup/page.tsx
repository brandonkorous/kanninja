...
const data: ComparisonData = {
    ...
    pickUsIf: [
        ...
        "You want no assistant in the product at all — just an open door for your own.",
    ],
    rows: [
        ...
        { feature: 'Built-in AI', kanninja: 'None, deliberately', competitor: 'ClickUp Brain (paid add-on)' },
    ...
    faqs: [
        ...
        {
            q: 'Is there anything like ClickUp Brain?',
            a: "No. Brain is ClickUp's model, billed per seat on top of your plan. We took our equivalent out rather than charge you twice — connect the agent you already pay for and it gets 42 tools on the board.",
        },
        {
